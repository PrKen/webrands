      ...
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-1/2 text-left animate-fadeIn">
          ...
          <p className="text-lg md:text-xl text-gray-600 mb-6">
            Développez tout votre potentiel avec <span className="text-primary font-bold">AXTRACOM</span> !
          </p>
        ...
        {/* Image à droite */}
        <div className="md:w-1/2 flex justify-center mt-8 md:mt-0 animate-fadeIn" style={{ animationDelay: "0.3s" }}>
          <img src="/public/illu2.jpg" alt="Illustration AXTRACOM" className="rounded-lg shadow-lg max-w-full h-auto" />
        </div>
      </div>
    </section>
  );
